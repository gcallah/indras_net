...
class CoopAgent(entity.Agent):
    ...
    def act(self):
        ...
        if self.coupons < 5.5:
            ...
            self.goal = GO_OUT
        print(self.name + ' acting with coupons = ' + str(self.coupons) + ' , goal = ' + self.goal)    
...
class CoopEnv(entity.Environment):
    
    def __init__(self, model_nm=None):
        super().__init__("Co-op Environment", model_nm=model_nm, preact=True )
        self.exchange_hist = []
        self.rd_exchanges = 0
