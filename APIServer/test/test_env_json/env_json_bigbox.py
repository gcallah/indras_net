def ret():
    ...
    "members": {
        ...
        "Mom and pop: Groceries": {
            ...
            "members": {
                "Mom and pop: Groceries 0": {
                    ...
                    "active": True,
                    "type_sig": 5,
                    "prim_group": "Mom and pop: Groceries",
                    "locator": "Town",
                    "neighbors": None,
                    "action_key": "mp_action"
                },
                "Mom and pop: Groceries 3": {
                    "name": "Mom and pop: Groceries 3",
                    "type": "agent",
                    "duration": 9223372036854775805,
                    "pos": [
                        18,
        ...
        "Mom and pop: Hardware": {
            ...
            "members": {
                ...
                "Mom and pop: Hardware 4": {
                    "name": "Mom and pop: Hardware 4",
                    "type": "agent",
                    "duration": 9223372036854775805,
                    "pos": [
                        8,
    ...
    "props": {
        ...
        "consumer_num": {
            "val": 50,
            "question": "How many consumers woud you like?",
            "atype": "INT",
            "lowval": 50,
            "hival": 400
        },
        ...
        "mp_num": {
            "val": 5,
            "question": "How many mom and pop stores woud you like?",
            "atype": "INT",
            "lowval": 5,
            "hival": 30
        },
        "mp_pref": {
            "val": 0.1,
            "question": "How much percentage preference should customers have to mom and pop stores?",
            "atype": "DBL",
            "lowval": 0.0,
            "hival": 0.4
        },
